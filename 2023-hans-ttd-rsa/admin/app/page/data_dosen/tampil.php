        ...
        <table <?php tabel(100, '%', 1, 'left');  ?>>
            ...
            <tbody>
                ...
                if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                    ...
                    $querytabel = "SELECT * FROM data_dosen where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_dosen where $berdasarkan like '%$isi%'";
                } else {
                    $querytabel = "SELECT * FROM data_dosen  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_dosen";
                }
