				...
				<table <?php tabel_in(100,'%',0,'center');  ?>>	
					<tbody>
						...
						<tr>
							...
							<td width="2%">:</td>
							<td>
								<input type="%typepertama%" name="id_mahasiswa" value="<?php echo $data['id_mahasiswa']; ?>" readonly  id="id_mahasiswa" required="required">		
							</td>
						</tr>
						...
						<tr>
							...
							<td width="2%">:</td>
							<td>
								<input class=''   required="required" type="text" name="nama" id="name" placeholder="Nama" value="<?php echo ($data['nama']); ?>">
