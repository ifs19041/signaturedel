...
<th class="th_border cell"  >Name</th>
...
<td align="center"><?php echo baca_database("", "name", " select * from data_mahasiswa=id_mahasiswa where id_mahasiswa ='$data[id_mahasiswa]'") ?></td>
<td align="center"><?php echo ($data['id_dosen']); ?></td>
<td align="center"><?php echo baca_database("", "name", " select * from data_dosen where id_dosen ='$data[id_dosen]'") ?></td>
<td align="center"><?php echo (format_indo($data['tanggal'])); ?></td>
<td align="center"><?php echo ($data['nama']); ?></td>
<td align="center"><a href='../../../../admin/upload/<?php echo $data['file']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../../admin/upload/<?php echo $data['file']; ?>'></a></td>
