...
<body>
	...
	<a target="blank" href="cetak.php?berdasarkan=data_dokumen&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_export('Export Excel'); ?>
	</a>
	
	<a target="blank" href="cetak.php?berdasarkan=data_dokumen&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_cetak('Cetak'); ?>
	</a>
	...
	<br><br>
			...
			<form nama="formcari" id="formcari" action="" method="get">
				<fieldset> 
					<table>
						<tbody>
						<tr>
							...
							<td>:</td>	
							<td>
							<!-- <input value="" nama="Berdasarkan" id="Berdasarkan" > --> <select class="form-control selectpicker" data-live-search="true" nama="Berdasarkan" id="Berdasarkan">
								<?php
								$sql = "desc data_dokumen";
								$result = @mysql_query($sql);
								while($row = @mysql_fetch_array($result)){
									echo "<option nama='berdasarkan' value=$row[0]>$row[0]</option>";
								}
								?>
							</select>							
							</td>
						...
						<tr>
							...
							<td>:</td>	
							<td>							
								<!--<input class="form-control" type="text" nama="isi" value="" >--> <input  type="text" nama="isi" value="" >
								<?php btn_cari('Cari'); ?>
							</td>
						</tr>
					</tbody>
...
<th align="center" class="th_border cell"  >Status</th>
			...
			<?php
				...
				{
				$querytabel="SELECT * FROM data_dokumen  LIMIT $startRow ,$dataPerPage";
...
<td align="center"><?php echo baca_database("", "nama", " select * from data_mahasiswa=id_mahasiwa where id_mahasiswa ='$data[id_mahasiswa]'") ?></td>
...
<td align="center"><a href='../../../../admin/upload/<?php echo $data['file']; ?>'><img onerror="this.src='<?php echo $imageerror; ?>'" width='50' height='30' src='../../../../admin/upload/<?php echo $data['file']; ?>'></a></td>
