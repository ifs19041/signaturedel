        ...
        <table <?php tabel_in(100, '%', 0, 'center');  ?>>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="clleft" width="2%">:</td>
                    <td class="clleft"><?php echo baca_database("", "nama", "select * from data_mahasiswa where id_mahasiwa='$data[id_mahasiswa]'") ?></td>
                </tr>
                ...
                <tr>
                    <td class="clleft" width="25%">Nama File</td>
                    <td class="clleft" width="2%">:</td>
            ...
            <tr>
                <td>
                    <form action="verifikasi.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-danger">Verifkasi Tanda Tangan</button>
                    </form>
                </td>
            </tr>
