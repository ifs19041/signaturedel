...
<table <?php tabel_in(100,'%',0,'center');  ?>>		
	<tbody>
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input type="readonly" readonly value="<?php echo id_otomatis("data_mahasiswa","id_mahasiwa","10");?>" name="id_mahasiwa" placeholder="id_mahasiwa" id="id_mahasiwa" required="required">		
				</td>
			   </tr>
