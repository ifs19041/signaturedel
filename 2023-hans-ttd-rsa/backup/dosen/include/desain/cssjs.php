<?php if ($meta_head == 1) { ?>
    ...
    ?>
        <link rel="stylesheet" href="../../../data/cssjs/combosearch/css/bootstrap-select.min.css" />
        <script type="text/javascript" src="../../../data/cssjs/combosearch/js/jquery-3.1.0.min.js"></script>
        <script type="text/javascript" src="../../../data/cssjs/combosearch/js/bootstrap-select.min.js"></script>
    <?php
    }
    ?>
    <?php if ($combosearch == 2) {
    ?>
        <link rel="stylesheet" href="admin/data/cssjs/combosearch/css/bootstrap-select.min.css" />
        <script type="text/javascript" src="admin/data/cssjs/combosearch/js/jquery-3.1.0.min.js"></script>
        <script type="text/javascript" src="admin/data/cssjs/combosearch/js/bootstrap-select.min.js"></script>
    <?php
    }
    ?>
