        ...
        <table <?php tabel(100, '%', 1, 'left');  ?>>
            ...
            <tbody>
                ...
                if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                    ...
                    $querytabel = "SELECT * FROM data_dokumen where id_dosen = '$id_dosen' LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_dokumen where id_dosen = '$id_dosen'";
                }
