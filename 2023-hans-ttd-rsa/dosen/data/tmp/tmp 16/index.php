            ...
            <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">
                                <i class="fa fa-bell fa-lg"></i> <span class="badge badge-header badge-warning">
                                    ...
                                    echo baca_database("", "total", "SELECT COUNT(*) as total FROM data_dokumen WHERE status='proses' and id_dosen='$id_dosen'");
                                    ?>
                                </span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-md with-arrow">
                                <div class="pad-all bord-btm">
                                    <div class="h4 text-muted text-thin mar-no">
                                       Dokumen Yang Perlu Ditanda tangani
                                    </div>
                                </div>
                                <div class="nano scrollable has-scrollbar" style="height: 245px;">
                                    <div class="nano-content" tabindex="0" style="right: -15px;">
                                        <ul class="head-list">
                                            <?php
                                             $id_dosen = decrypt($_COOKIE['kodene']);
                                            $querytabel = "SELECT * FROM data_dokumen WHERE status='proses' and id_dosen='$id_dosen'";
