 <?php
    ...
    if (isset($_POST["login"])) {
        ...
        $r = mysql_query("select * from data_dosen where password='$password' and username='$username'");
...
if (mysql_num_rows($r) == 1) {
                    ...
                    setcookie('hak_akses', 'dosen', time() + (6000 * 6000), '/');
