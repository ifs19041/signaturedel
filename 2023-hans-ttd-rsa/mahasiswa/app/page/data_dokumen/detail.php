        ...
        <table <?php tabel_in(100, '%', 0, 'center');  ?>>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="clleft" width="2%">:</td>
                    <td class="clleft"><?php echo baca_database("", "name", " select * from data_mahasiswa=id_mahasiswa where id_mahasiswa ='$data[id_mahasiswa]'") ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="clleft" width="25%">Name</td>
                    <td class="clleft" width="2%">:</td>
                    <td class="clleft"><?php echo baca_database("", "name", " select * from data_dosen where id_dosen ='$data[id_dosen]'") ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="clleft" width="2%">:</td>
                    <td class="clleft"><a href='../../../../admin/upload/<?php echo $data['file']; ?>'><img onerror="this.src='<?php echo $imageerror; ?>'" width='250' src='../../../../admin/upload/<?php echo $data['file']; ?>'></a></td>
                </tr>
                <tr>
