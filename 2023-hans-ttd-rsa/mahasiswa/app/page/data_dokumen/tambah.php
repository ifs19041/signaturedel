    ...
    <form action="proses_simpan.php" enctype="multipart/form-data" method="post">
        <div class="content-box-content">
            <div id="postcustom">
				...
				function encryptsha256($enc_id){
					$hashed_id = hash('sha256', $enc_id);
					return $hashed_id;
				  }
				  $hashed_id = id_otomatis("data_dokumen","id_dokumen","10");
				  echo encryptsha256($hashed_id);
				
				?>" name="id_dokumen" placeholder="id_dokumen" id="id_dokumen" required="required">
                            </td>
                        </tr>


                        <input  class='' value="<?php echo $id_mahasiswa = decrypt($_COOKIE['kodene']); ?>" type="hidden" name="id_mahasiswa" id="id_mahasiswa" placeholder="id_mahasiswa" required="required">
                        <!-- <tr>
							<td width="25%" class="leftrowcms">					
							...
							<td>
								...
								<select  class=' selectpicker' data-live-search='true'  type="text" name="id_mahasiswa" id="id_mahasiswa" placeholder="Id&nbsp;Mahasiswa" required="required">
									<option></option><?php combo_database2('data_mahasiswa', 'id_mahasiswa', 'name', ''); ?>
								</select>		
							</td>
						</tr>
