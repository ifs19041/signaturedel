...
<table <?php tabel_in(100,'%',0,'center');  ?>>		
	<tbody>
			   <tr>
				...
				<label >id&nbsp;mahasiwa <span class="highlight">*</span></label>
			   </td>
				<td width="2%">:</td>
				<td>
				<input type="readonly" readonly value="<?php echo id_otomatis("data_mahasiswa","id_mahasiswa","10");?>" name="id_mahasiswa" placeholder="id_mahasiswa" id="id_mahasiswa" required="required">		
				</td>
			   </tr>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input class='' type="text" name="name" id="name" placeholder="Name" required="required">
